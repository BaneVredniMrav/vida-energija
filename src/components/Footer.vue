    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
      <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-1">
          ...
          <div class="flex gap-4 mt-6">
            <a href="#" class="w-10 h-10 bg-gray-800 hover:bg-vida-500 rounded-lg flex items-center justify-center transition-colors">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li class="flex items-center gap-2">
              <svg class="w-5 h-5 text-vida-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
              </svg>
              <a href="tel:+38163123456" class="hover:text-vida-400 transition-colors">+381 63 123 456</a>
            </li>
            <li class="flex items-center gap-2">
              <svg class="w-5 h-5 text-vida-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
              <a href="mailto:info@vidaenergija.rs" class="hover:text-vida-400 transition-colors">info@vidaenergija.rs</a>
            </li>
            <li class="flex items-start gap-2">
              <svg class="w-5 h-5 text-vida-400 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div class="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex gap-6 text-sm">
          ...
          <a href="#" class="hover:text-vida-400 transition-colors">Uslovi korišćenja</a>
        </div>
      </div>
    </div>
  </footer>
